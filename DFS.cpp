...
void DFS(int **adjMatrix, int *isVisited, int curNode, map<char, int> allNodesMap, int numOfNodes)
{
    ...
    {
        if (adjMatrix[curNode][i] != 0 && isVisited[i] == 0)
            DFS(adjMatrix, isVisited, i, allNodesMap, numOfNodes);
    }
}
int main()
{
